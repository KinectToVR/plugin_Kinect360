...
public interface IPolicyConfig
{
    ...
    uint GetDeviceFormat([In] [MarshalAs(UnmanagedType.LPWStr)] string pszDeviceName, [In] [MarshalAs(UnmanagedType.Bool)] bool bDefault,
        out WaveFormatExtensible ppFormat);

    uint ResetDeviceFormat([In] [MarshalAs(UnmanagedType.LPWStr)] string pszDeviceName);

    uint SetDeviceFormat([In] [MarshalAs(UnmanagedType.LPWStr)] string pszDeviceName,
        [In] [MarshalAs(UnmanagedType.LPStruct)]
        WaveFormatExtensible pEndpointFormat,
        [In] [MarshalAs(UnmanagedType.LPStruct)]
        WaveFormatExtensible pMixFormat);

    uint GetProcessingPeriod([In] [MarshalAs(UnmanagedType.LPWStr)] string pszDeviceName, [In] [MarshalAs(UnmanagedType.Bool)] bool bDefault,
    ...
    uint GetPropertyValue([In] [MarshalAs(UnmanagedType.LPWStr)] string pszDeviceName, [In] [MarshalAs(UnmanagedType.Bool)] bool bFxStore, ref PropertyKey pKey,
        out PropVariant pv);

    uint SetPropertyValue([In] [MarshalAs(UnmanagedType.LPWStr)] string pszDeviceName, [In] [MarshalAs(UnmanagedType.Bool)] bool bFxStore,
        [In] ref PropertyKey pKey, ref PropVariant pv);
...
public static class DevicePolicy
{
    public static bool SetAudioEndpointState(string deviceId, bool state)
    {
        ...
        var pPolicyConfig = (IPolicyConfig)PolicyConfig;
